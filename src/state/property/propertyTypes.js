export const FETCH_ALL_PROPERTIES_REQUEST = 'FETCH_ALL_PROPERTIES_REQUEST';
export const FETCH_ALL_PROPERTIES_SUCCESS = 'FETCH_ALL_PROPERTIES_SUCCESS';
export const FETCH_ALL_PROPERTIES_ERROR = 'FETCH_ALL_PROPERTIES_ERROR';

export const FETCH_MANAGED_PROPERTIES_REQUEST = 'FETCH_MANAGED_PROPERTIES_REQUEST';
export const FETCH_MANAGED_PROPERTIES_SUCCESS = 'FETCH_MANAGED_PROPERTIES_SUCCESS';
export const FETCH_MANAGED_PROPERTIES_ERROR = 'FETCH_MANAGED_PROPERTIES_ERROR';
